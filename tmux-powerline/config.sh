...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="kryses"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/kryses/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/kryses/.mailcheckrc"
# }
